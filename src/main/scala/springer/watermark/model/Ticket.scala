 ...
 */
case class Ticket(var ticketStatus: TicketStatus, id: String = MessageDigest.getInstance("MD5").digest(HashCode.hash(10,1000).toString().getBytes()).map("%02X".format(_)).mkString )
